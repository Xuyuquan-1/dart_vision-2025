...
static const _Uartf_type_support_symbol_names_t _Uartf_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_interfaces, msg, Uartf)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vision_interfaces, msg, Uartf)),
  }
};
...
{
  return &::vision_interfaces::msg::rosidl_typesupport_cpp::Uartf_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vision_interfaces, msg, Uartf)() {
  return get_message_type_support_handle<vision_interfaces::msg::Uartf>();
}
